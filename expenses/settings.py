...
SECRET_KEY = 'django-insecure-0*n-4u4e3=hxl92e4b36bl2_qyj*4u%%c86=iv(&0%2tcf$g3m'
...
INSTALLED_APPS = [
    ...
    'user.apps.UserConfig',  # Use the AppConfig class
...
import pymysql
pymysql.install_as_MySQLdb()  # Monkey-patch for Django compatibility
# Password validation
...
# settings.py
KAFKA_CONFIG = {
    'bootstrap.servers': 'localhost:29092',  # Use the external port
